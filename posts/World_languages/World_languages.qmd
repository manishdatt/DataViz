    ...
    <script>
        window.addEventListener('load', () => {
            ...
            .then(([endText, famText, langText]) => {
                ...
                // Define unique colors for each status code (0-6)
                const statusColors = {
                    "0": "#BDBDBD",  // Blue for NA
                    "1": "#2E7D32",  // Orange for not endangered
                    "2": "#9CCC65",  // Green for vulnerable
                    "3": "#FBC02D",  // Red for shifting
                    "4": "#EF6C00",  // Purple for moribund
                    "5": "#C62828",  // Brown for nearly extinct
                    "6": "#6D5C6D"   // Pink for extinct
                };
